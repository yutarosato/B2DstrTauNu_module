...
namespace Belle{
			       ...
			       )
  {
    ...
    int cnt        = 0;
    //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    if     ( abs(kaon_list.begin()->lund())==Kplus_LUND && abs(pion_list.begin()->lund())==PIplus_LUND && abs(pi0_list.begin()->lund())==PI0_LUND ) rec_mode_d = 1201; // [charged K  + charged pi + chargedpi + pi0 ]
    else if( abs(kaon_list.begin()->lund())==Ks_LUND    && abs(pion_list.begin()->lund())==PIplus_LUND && abs(pi0_list.begin()->lund())==PI0_LUND ) rec_mode_d = 1210; // [        Ks + charged pi + chargedpi + pi0 ]
