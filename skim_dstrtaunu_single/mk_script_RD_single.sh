...
set NAME   = `basename $FILE .mdst | cut -d "-" -f 2`


set OUT   = 'script_single/rd/'$FLAG'_'$NAME'.sh'
set LOG   =    'log_single/rd/'$FLAG'_'$NAME'.log'
set HBK   =    'hbk_single/rd/'$FLAG'_'$NAME'.hbk'
set MDST  =   'mdst_single/rd/'$FLAG'_'$NAME'.mdst'
#set MDST  =  'index_single/rd/'$FLAG'_'$NAME'.index'
...
echo "mkdir -p   mdst_single/rd" >> $OUT
#echo "mkdir -p  index_single/rd" >> $OUT
