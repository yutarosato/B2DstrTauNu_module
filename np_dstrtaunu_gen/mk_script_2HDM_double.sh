...
set  OUT = 'script/'$MODE'_double/'$FLAG'_'$MODE'_'$EXP'_set'$TAG'.sh'
set  LOG =    'log/'$MODE'_double/'$FLAG'_'$MODE'_'$EXP'_set'$TAG'.log'
set  HBK =    'hbk/'$MODE'_double/'$FLAG'_'$MODE'_'$EXP'_set'$TAG'.hbk'
#set MDST =   'mdst/'$MODE'_double/'$FLAG'_'$MODE'_'$EXP'_set'$TAG'.mdst'
     
mkdir -p 'script/'$MODE'_double'
#****************************************
...
echo "mkdir -p    log/"$MODE"_double" >> $OUT
echo "mkdir -p    hbk/"$MODE"_double" >> $OUT
