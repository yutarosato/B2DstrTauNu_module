...
set  OUT = "script/OP_${TYPE}_${MODE}/${FLAG}_${TYPE}_${MODE}_${EXP}_set${TAG}.sh"
set  LOG =    "log/OP_${TYPE}_${MODE}/${FLAG}_${TYPE}_${MODE}_${EXP}_set${TAG}.log"
set  HBK =    "hbk/OP_${TYPE}_${MODE}/${FLAG}_${TYPE}_${MODE}_${EXP}_set${TAG}.hbk"
     
mkdir -p "script/OP_${TYPE}_${MODE}"
#****************************************
...
echo "mkdir -p    log/OP_${TYPE}_${MODE}" >> $OUT
echo "mkdir -p    hbk/OP_${TYPE}_${MODE}" >> $OUT
