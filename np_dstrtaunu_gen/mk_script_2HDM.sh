...
set  OUT = 'script/'$MODE'/'$FLAG'_'$MODE'_'$EXP'_set'$TAG'.sh'
set  LOG =    'log/'$MODE'/'$FLAG'_'$MODE'_'$EXP'_set'$TAG'.log'
set  HBK =    'hbk/'$MODE'/'$FLAG'_'$MODE'_'$EXP'_set'$TAG'.hbk'
#set MDST =   'mdst/'$MODE'/'$FLAG'_'$MODE'_'$EXP'_set'$TAG'.mdst'
