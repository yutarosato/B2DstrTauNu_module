...
set  OUT = "script/${TYPE}_${MODE}/${FLAG}_${TYPE}_${MODE}_${EXP}_set${TAG}.sh"
set  LOG =    "log/${TYPE}_${MODE}/${FLAG}_${TYPE}_${MODE}_${EXP}_set${TAG}.log"
set  HBK =    "hbk/${TYPE}_${MODE}/${FLAG}_${TYPE}_${MODE}_${EXP}_set${TAG}.hbk"
     
mkdir -p "script/${TYPE}_${MODE}"
#****************************************
...
echo "mkdir -p    log/${TYPE}_${MODE}" >> $OUT
echo "mkdir -p    hbk/${TYPE}_${MODE}" >> $OUT
