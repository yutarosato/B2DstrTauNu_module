...
namespace Belle{
  ...
  int DSTRTAUNU::event_start()
  {
    ...
    //flag_single = true;
    //flag_hadtag = true;
    //if( !(runNo==279 && evtNo==8007) ) return 0;
    //if( !(runNo==680 && evtNo==126466) ) return 0;
    //if( !(runNo==371 && evtNo==2523) ) return 0;
    //if( !(runNo==162 && evtNo==10034) ) return 0;
    //if( !(runNo==1256 && evtNo==47473) ) return 0;
    //if( !(runNo==1765 && evtNo==23725) ) return 0;
    //if( !(runNo==811 && evtNo==2782) ) return 0;
    //if( runNo!=371 ) return 0;
    ...
    Rec_Dstr ( recdstrp_list, recd0_list, pion_list,         0.007,  fl_message_rec ); // D0 pi+ // expand to 7 MeV @20150202
    Rec_Dstr ( recdstrp_list, recdp_list, pi0_for_dstr_list, 0.007,  fl_message_rec ); // D+ pi0 // expand to 7 MeV @20150202
