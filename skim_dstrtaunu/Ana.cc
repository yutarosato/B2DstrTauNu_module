...
namespace Belle{
		      ...
		      BelleTuple* dist, const bool fl_message )
  {
	...
	if( remtrk || rempi0 || remks ){
	  ...
	  if( remtrk + remks > 1 ) continue; // modified @20150202
	}
	...
	Particle* extra_pi0 =  search_remain_pi0(Dtau1, Dtau2, pi0_list_test1); // default setting
	dist->column( "eecl_ex", calEclEnergyWithMatch2GoodGamma_mask(Dtau1, Dtau2, !true, NULL, NULL, l_lep, extra_pi0, gen_b_decay_info[0][0], gen_b_decay_info[1][0] ) ); // valid only for #extra_pi0==1
	// +++++++++++++++++++++++++++++++++++++ [ momentum ] +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
