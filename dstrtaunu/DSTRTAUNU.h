...
namespace Belle {
  ...
  protected:
    ...
    int check_selfPi0 ( Particle& particle                         ); // Util_Gen.cc
    ...
    double calEclEnergyWithMatch2GoodGamma_mask( const Particle& B1,     const Particle& B2, const bool fl_message=false,
						 double eecl[39]=NULL, int neecl[39]=NULL,
						 const Particle* l_lep=NULL,
						 const Particle* veto_pi0=NULL,
						 const int id1=0, const int id2=0,
						 const double width=6.0, const double e9e25=0.94,
						 const double th_fw=0.10,    const double th_br=0.05, const double th_bw=0.15
    ...
    Particle* search_remain_pi0( const Particle& B1, const Particle& B2, std::vector<Particle>& pi0_list   ); // Util_dstrtaunu.cc
    ...
    int cnt_remain_gamma_energy( const Particle& B1, const Particle& B2, std::vector<Particle>& gamma_list,
				 const  double th_fw, const double th_br, const double th_bw        ); // Util_dstrtaunu.cc
    ...
    void extra_pi0_study( Particle Dtau_l, Particle Dtau_h, Particle D_l, Particle D_h,
    ...
    void calKinematics_np( int id_b, int id_d, int id_tau,
