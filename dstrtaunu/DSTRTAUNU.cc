...
namespace Belle{
  ...
  DSTRTAUNU::DSTRTAUNU() :
    ...
    Dr_cut         ( 2.0 ), // cm
    Dz_cut         ( 5.0 ), //
    masscut_pi0_L  ( -0.015 ), // -0.030
    masscut_pi0_H  (  0.010 ), // +0.030
    //masscut_pi0_L  ( -0.035 ), // -0.030
    //masscut_pi0_H  (  0.030 ), // +0.030
    masscut_D_L    ( -0.060 ), // -0.150, -0.100, 0.045
    masscut_D_H    (  0.050 )  // +0.120,  0.060, 0.045
  {
    std::cout << " +++++++++++++++++++++++++++++++++++++++++++++++++++ " << std::endl;
  ...
  void DSTRTAUNU::hist_def()
  {
    ...
    sTmp_rec << " exprun event evt_type "                     // [ number ]
	     ...
	     << " remg remg05 remg10 remg15 "                   // added @20150727
	     ...
	     << " dst1_pi0cos acc1self acc1org acc1mo acc1gmo " // [accompany particles]
	     << " dst2_pi0cos acc2self acc2org acc2mo acc2gmo " //
	     ...
	     << " eecl_exp epi_pie  epi_gle  epi_ghe  epi_cl  epi_ml  epi_ch  epi_mh "
	     << " eecl_ex0 epi0_pie epi0_gle epi0_ghe epi0_cl epi0_ml epi0_ch epi0_mh "
	     << " eecl_ex1 epi1_pie epi1_gle epi1_ghe epi1_cl epi1_ml epi1_ch epi1_mh "
	     << " eecl_ex2 epi2_pie epi2_gle epi2_ghe epi2_cl epi2_ml epi2_ch epi2_mh "
	     << " eecl_ex3 epi3_pie epi3_gle epi3_ghe epi3_cl epi3_ml epi3_ch epi3_mh "
	     << " eecl_ex4 epi4_pie epi4_gle epi4_ghe epi4_cl epi4_ml epi4_ch epi4_mh "
	     << " eecl_ex5 epi5_pie epi5_gle epi5_ghe epi5_cl epi5_ml epi5_ch epi5_mh "
	     << " eecl_ex6 epi6_pie epi6_gle epi6_ghe epi6_cl epi6_ml epi6_ch epi6_mh "
	     << " eecl_ex7 epi7_pie epi7_gle epi7_ghe epi7_cl epi7_ml epi7_ch epi7_mh "
	     << " eecl_ex8 epi8_pie epi8_gle epi8_ghe epi8_cl epi8_ml epi8_ch epi8_mh "
      //<< " mu1ecl mu1reg mu1org mu1th mu1e9e25 mu1ewid " // [low muon track study]
      //<< " mu2ecl mu2reg mu2org mu2th mu2e9e25 mu2ewid " //
	     << " d1ch0recid d1ch0selfid d1ch0gmo d1ch0mo d1ch0org "     // [D's daughter]
	     << " d1ch1recid d1ch1selfid d1ch1gmo d1ch1mo d1ch1org "     //
	     << " d1ch2recid d1ch2selfid d1ch2gmo d1ch2mo d1ch2org "     //
	     << " d1ch3recid d1ch3selfid d1ch3gmo d1ch3mo d1ch3org "     //
	     << " d2ch0recid d2ch0selfid d2ch0gmo d2ch0mo d2ch0org "     //
	     << " d2ch1recid d2ch1selfid d2ch1gmo d2ch1mo d2ch1org "     //
	     << " d2ch2recid d2ch2selfid d2ch2gmo d2ch2mo d2ch2org "     //
	     << " d2ch3recid d2ch3selfid d2ch3gmo d2ch3mo d2ch3org "     // 
      ...
      //<< " cosdll_ctrl cosdlh_ctrl"                    // D** study
	     ...
	     << " ddst1_d ddst1_acc ddst1_nch "               // [ gen-mode (D**) ]
	     << " cc1 "                                       //
	     << " rootd1nc rootd2nc "                         // [D**(gen)]
	     << " fldstst1 fldstst2 "                         // [D**(gen)]
	     << " incl1gmc incl2gmc "                         // [D**(gen)]
	     ...
	     << " ddst2_d ddst2_acc ddst2_nch "               // [ gen-mode (D**) ]
	     << " cc2 "                                       //
	     << " ks1m ks2m ks1self ks2self "                 // [ks  mass] 20150717
	     ...
	     << " k1_q2 k1_pl k1_w k1_cos "       // [kinematics] @20141113
	     << " k2_q2 k2_pl k2_w k2_cos "       // [kinematics] @20141113
	     << " dec_tau dec_d "                       // [ decay mode  ]
	     << " q2 cos_d cos_w cos_t cos_dau"         // [ decay angle ]
	     << " p_dau_tau p_dau_w p_dau_b p_dau_lab " // [tau's daugher momentum]
	     << " ddst1m ddst2m "                 // [D**(gen)]
	     << " ltrkchi ltrkndf ltrkcl "        // @20150414
      ;
    ...
    //pi0_dist = tm->ntuple( "pi0", "pi0e pi0m ghe gle cos self selfg1 selfg2", 111 );
