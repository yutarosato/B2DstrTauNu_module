...
namespace Belle{
		      ...
		      BelleTuple* dist, const bool fl_message )
  {
	...
	if( info_Dstr1.dm()==-1 ){ // B -> D lnu
	  ...
	  if( dst1self==1 ) dst1org = which_B( Dstr1.genHepevt(), gen_b_decay_info[0][0], gen_b_decay_info[1][0] );
	  UserInfo& info_acc1 = dynamic_cast<UserInfo&>( Dstr1.child(1).userInfo() );
	  acc1self = info_acc1.self();
	  if( acc1self==1 ) acc1org = which_B( Dstr1.child(1).genHepevt(), gen_b_decay_info[0][0], gen_b_decay_info[1][0] );
	}
	...
	if( info_Dstr2.dm()==-1 ){ // B -> D lnu
	  ...
	  if( dst2self==1 ) dst2org = which_B( Dstr2.genHepevt(), gen_b_decay_info[0][0], gen_b_decay_info[1][0] );
	  UserInfo& info_acc2 = dynamic_cast<UserInfo&>( Dstr2.child(1).userInfo() );
	  acc2self = info_acc2.self();
	  if( acc2self==1 ) acc2org = which_B( Dstr2.child(1).genHepevt(), gen_b_decay_info[0][0], gen_b_decay_info[1][0] );
	}
	...
	if( info_D1.self()==1 ) dist->column( "d1moid", D1.genHepevt().mother().idhep() );
	else                    dist->column( "d1moid", 0                               );
	if( info_D2.self()==1 ) dist->column( "d2moid", D2.genHepevt().mother().idhep() );
	else                    dist->column( "d2moid", 0                               );

	int d1org = -1;
	int d2org = -1;
	if( info_D1.self()==1 ) d1org = which_B( D1.genHepevt(), gen_b_decay_info[0][0], gen_b_decay_info[1][0] );
	if( info_D2.self()==1 ) d2org = which_B( D2.genHepevt(), gen_b_decay_info[0][0], gen_b_decay_info[1][0] );
	...
	for( int i=0; i<4; i++ ){
	  ...
	  if      ( i==0 ){ dist->column( "d1ch0recid", reclund ); dist->column( "d1ch0selfid", genlund ); dist->column( "d1ch0mo", moid ); dist->column( "d1ch0org", org ); dist->column( "d1ch0p", mom ); dist->column( "d1ch0pc", cos );
	  }else if( i==1 ){ dist->column( "d1ch1recid", reclund ); dist->column( "d1ch1selfid", genlund ); dist->column( "d1ch1mo", moid ); dist->column( "d1ch1org", org ); dist->column( "d1ch1p", mom ); dist->column( "d1ch1pc", cos );
	  }else if( i==2 ){ dist->column( "d1ch2recid", reclund ); dist->column( "d1ch2selfid", genlund ); dist->column( "d1ch2mo", moid ); dist->column( "d1ch2org", org ); dist->column( "d1ch2p", mom ); dist->column( "d1ch2pc", cos );
	  }else if( i==3 ){ dist->column( "d1ch3recid", reclund ); dist->column( "d1ch3selfid", genlund ); dist->column( "d1ch3mo", moid ); dist->column( "d1ch3org", org ); dist->column( "d1ch3p", mom ); dist->column( "d1ch3pc", cos );
	  }
	}
	...
	for( int i=0; i<4; i++ ){
	  ...
	  if      ( i==0 ){ dist->column( "d2ch0recid", reclund ); dist->column( "d2ch0selfid", genlund ); dist->column( "d2ch0mo", moid ); dist->column( "d2ch0org", org ); dist->column( "d2ch0p", mom ); dist->column( "d2ch0pc", cos );
	  }else if( i==1 ){ dist->column( "d2ch1recid", reclund ); dist->column( "d2ch1selfid", genlund ); dist->column( "d2ch1mo", moid ); dist->column( "d2ch1org", org ); dist->column( "d2ch1p", mom ); dist->column( "d2ch1pc", cos );
	  }else if( i==2 ){ dist->column( "d2ch2recid", reclund ); dist->column( "d2ch2selfid", genlund ); dist->column( "d2ch2mo", moid ); dist->column( "d2ch2org", org ); dist->column( "d2ch2p", mom ); dist->column( "d2ch2pc", cos );
	  }else if( i==3 ){ dist->column( "d2ch3recid", reclund ); dist->column( "d2ch3selfid", genlund ); dist->column( "d2ch3mo", moid ); dist->column( "d2ch3org", org ); dist->column( "d2ch3p", mom ); dist->column( "d2ch3pc", cos );
	  }
	}
	...
	dist->column( "rootds1",   gen_b_decay_info[0][ 7] ); dist->column( "rootds2",   gen_b_decay_info[1][ 7] );
