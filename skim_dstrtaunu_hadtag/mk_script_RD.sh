...
set NAME = `printf "e%03dc%03d" $expNo $CNT`

set OUT   = 'script_hadtag/rd/'$FLAG'_'$NAME'.sh'
set LOG   =    'log_hadtag/rd/'$FLAG'_'$NAME'.log'
set HBK   =    'hbk_hadtag/rd/'$FLAG'_'$NAME'.hbk'
set MDST  =   'mdst_hadtag/rd/'$FLAG'_'$NAME'.mdst'
#set MDST  =  'index_hadtag/rd/'$FLAG'_'$NAME'.index'
...
echo "mkdir -p   mdst_hadtag/rd" >> $OUT
#echo "mkdir -p  index_hadtag/rd" >> $OUT
...
~syutaro/script/mk_data_list_rd.sh $expNo $runNoi $runNof >> $OUT
