...
mkdir -p    log_hadtag/mixed
mkdir -p    hbk_hadtag/mixed
mkdir -p   mdst_hadtag/mixed
basf << EOF >  test.log
...
process_url http://bweb3/montecarlo.php?ex=31&rs=231&re=232&ty=evtgen-mixed&dt=on_resonance&bl=caseB&dv=zfserv&st=0
