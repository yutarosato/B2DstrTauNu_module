...
namespace Belle{
  ...
  int DSTRTAUNU::event_start()
  {
    ...
    if( flag_hadtag && FullReconN( B0_LUND, 0.010, 0)==0 ) return 0;
    ...
    std::vector<Particle> pi0_test4; Pi0_cand( pi0_test4, -0.025, 0.025,   0.0, 0.050, 0.050, -10.0, fl_message_funda ); // mass range
